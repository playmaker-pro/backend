...
class ProductMail:
    ...
    def mail_admins_about_new_product_request(self, instance, extra_body=None):
        ...
        message = (
            f"Użytkownik {instance.user.username} {instance.user.first_name} ({instance.user.declared_role}) własnie wysłał zgłoszenie o product. \n\n "
        ...
        if instance.product.contact_email:
            send_mail(
                ...
                [instance.product.contact_email],
            )
