...
class ClubForPlayerAnnouncementForm(forms.ModelForm):
    ...
    building_fields = [
        ...
        ("new_voivodeship", "Województwo", None, {}),
        ...
        (
            "body",
            "Wprowadź najważniejsze informacje na temat Twojego klubu oraz testów",
            None,
            {},
        ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.label_class = (
            "col-12 col-md-4 text-md-right text-muted upper form-label"
        )
    ...
    def set_fields_rules(self):
        ...
        self.fields[
            "year_from"
        ].label = "Rocznik od"  # '<i class="icofont-ui-user-group"></i>'
        self.fields["year_from"].help_text = False

        self.fields["year_to"].required = True
        self.fields[
            "year_to"
        ].label = "Rocznik do"  # '<i class="icofont-ui-user-group"></i>'
        self.fields["year_to"].help_text = False

        self.fields["league"].widget = forms.HiddenInput()
        self.fields[
            "league"
        ].label = "Poziom rozgrywkowy"  # '<i class="icofont-ui-user-group"></i>'
        ...
        self.fields["new_voivodeship"].widget = forms.HiddenInput()
        self.fields["new_voivodeship"].label = "Województwo"
        self.fields["new_voivodeship"].help_text = False
        ...
        self.fields[
            "www"
        ].label = "Link www ogłoszenia / strony internetowej klubu (opcjonalnie)"  # '<i class="icofont-ui-user-group"></i>'
    ...
    def build_verification_form(self):
        fds = (
            ...
            + [
                ...
                for fn, fp, fc, kwargs in self.building_fields
            ]
        )
...
class PlayerForClubAnnouncementForm(forms.ModelForm):
    ...
    def set_fields_rules(self):
        ...
        self.fields["new_voivodeship"].required = True
        self.fields["new_voivodeship"].label = "Województwo"
        self.fields["new_voivodeship"].help_text = False
        ...
        self.fields[
            "practice_distance"
        ].label = "Maksymalna odległość dojazdu w km"  # '<i class="icofont-ui-user-group"></i>'
        self.fields["practice_distance"].help_text = False

        self.fields["target_league"].required = True
        self.fields[
            "target_league"
        ].label = "Cel poszukiwań"  # '<i class="icofont-ui-user-group"></i>'
...
class CoachForClubAnnouncementForm(forms.ModelForm):
    ...
    building_fields = [
        ...
        (
            "body",
            "Opisz krótko swoje dotychczasowe osiągniecia oraz oczekiwania",
            None,
            {},
        ),
    ]
    ...
    def set_fields_rules(self):
        ...
        self.fields[
            "league"
        ].label = "Obecna liga"  # '<i class="icofont-ui-user-group"></i>'
        self.fields["league"].help_text = False
        self.fields["league"].widget = forms.HiddenInput()
