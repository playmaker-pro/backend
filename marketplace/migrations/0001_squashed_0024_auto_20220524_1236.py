...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("marketplace", "0021_playerforclubannouncement_league"),
        ("marketplace", "0022_auto_20220118_0119"),
        ("marketplace", "0023_auto_20220118_0143"),
        ("marketplace", "0024_auto_20220524_1236"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=3,
                        validators=[
                            django.core.validators.RegexValidator("^\\d{1,3}$")
                        ],
                    ),
                ),
                ("body", models.TextField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "gender",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="clubs.gender"
                    ),
                ),
                (
                    "league",
