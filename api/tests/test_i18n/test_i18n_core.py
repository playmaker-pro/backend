...
from api.i18n import LanguageDetectionMixin, I18nViewMixin, I18nSerializerMixin
from api.i18n_config import SUPPORTED_LANGUAGE_CODES, DEFAULT_LANGUAGE, SUPPORTED_LANGUAGES
from api.tests.fixtures.test_models import TestI18nView, TestI18nSerializer, create_mock_request, create_mock_context
...
class I18nViewMixinTests(TestCase):
    ...
    def test_serializer_context_with_language(self):
        ...
        with patch('rest_framework.viewsets.GenericViewSet.get_serializer_context', return_value={'base': 'context'}):
...
class I18nMixinIntegrationTests(TestCase):
    ...
    def test_view_to_serializer_language_flow(self):
        ...
        with patch('rest_framework.viewsets.GenericViewSet.dispatch'):
            ...
            with patch('rest_framework.viewsets.GenericViewSet.get_serializer_context', return_value={}):
                context = self.view.get_serializer_context()
            serializer = TestI18nSerializer(context=context)
