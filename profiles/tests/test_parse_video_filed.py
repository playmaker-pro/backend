...
class ParseVideoUrl(TestCase):
    def setUp(self):
        self.urls = [
            ...
            ('https://megawrzuta.pl/download/472a2702739bf081c9f0c18a97245339.html', None),
            ...
            ('https://www.youtube.com/watch?v=zwrtBhYoCL8&feature=youtu.be&ab_channel=qevprodbm', 'zwrtBhYoCL8'),        
        ]
