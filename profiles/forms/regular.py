    ...
    def clean(self):
        ...
        if len(last_name) < 2:
            if self.request:
                ...
                messages.error(
                    self.request,
                    "Twoje konto wymaga werifikacji. Nazwisko musi miec co najmniej 2 znaki.",
                )
        ...
        self.helper.layout = Layout(
            Fieldset(
                ...
                Field(
                    "birth_date",
                    wrapper_class="row",
                    css_class=self.get_mandatory_field_class("birth_date"),
                ),
                ...
                Field("voivodeship_obj", wrapper_class="row"),
                css_class="col-md-6",
            ),
            Fieldset(
                _('<h2 class="form-section-title">Dane kontaktowe</h2>'),
...
class PlayerProfileForm(BaseProfileForm):
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                ...
                Field(
                    "height",
                    wrapper_class="row",
                    placeholder="130 - 210 cm",
                    css_class="mandatory",
                ),
                Field(
                    "weight",
                    wrapper_class="row",
                    placeholder="40 - 140 kg",
                    css_class="mandatory",
                ),
                Field(
                    "address",
            ...
            Fieldset(
                ...
                Field(
                    ...
                    wrapper_class="row",
                    css_class="mandatory",
                    placeholder="Maksymalna odległośc na trening",
                ),
                css_class="col-md-6",
            ),
            ...
            Fieldset(
                ...
                Field(
                    "agent_name",
                    wrapper_class="row",
                    placeholder="Imię i nazwisko / nazwa agencji",
                ),
                Field(
                    "agent_phone", wrapper_class="row", placeholder="+48 111 222 333"
                ),
    ...
    class Meta:
        ...
        fields = (
            models.PlayerProfile.COMPLETE_FIELDS
            + models.PlayerProfile.OPTIONAL_FIELDS
            + ["country", "birth_date"]
        )
...
class ScoutProfileForm(BaseProfileForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["voivodeship_obj"].help_text = None
        self.fields["voivodeship_obj"].label = "Wojewódźtwo"
        ...
        self.helper.layout = Layout(
            Fieldset(
                ...
                Field(
                    "voivodeship_obj", wrapper_class="row", placeholder="deklarowane"
                ),
                Field("country", wrapper_class="row"),
                Field(
                    "practice_distance",
                    wrapper_class="row",
                    placeholder="maksymalna w km",
                ),
                css_class="col-md-6",
            ),
            Fieldset(
                ...
                Field(
                    "address",
                    wrapper_class="row",
                    placeholder="np. Dolnyśląsk, Wrocław",
                ),
                Field(
                    "facebook_url",
                    wrapper_class="row",
