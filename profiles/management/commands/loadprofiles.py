...
class Command(BaseCommand):
    ...
    def practice_distance_map(self, param):
        ...
        if (
            param == "obojętnie"
            or param == "Nie gra roli"
            or param == "Dowolna"
            or param == "Nie ma znaczenia"
            or param == "Bez limitu"
            or param == "500+"
            or param == "Cała Polska"
            or param == "Dowolnie"
            or param == "niema ruznicy"
        ):
            return 500
        if (
            param == "Aksamitna 20"
            or param == "Nie wiem"
            or param == "Opatówko 28"
            or param == "Kętrzyńskiego 107/8"
            or param == "Osiedle Robotnicze 85/2"
            or param == "Dębieczna 58"
            or param == "Autobusy w obrębie okolic Poznania"
        ):
            return None
        if param == "5-6":
            return 6
        ...
        if (
            param
            == "50km (możliwość zmiany miejsca zamieszkania na terenie 2 grupy III ligi)"
        ):
            return 50
        if (
            param == "Nowa 25/1"
            or param == "Nagietkowa 3"
            or param == "Skarbka 2/45"
            or param == "Skalista 20"
            or param == "Sokoła 40"
            or param == "Ul. Akacjowa 8D/3"
        ):
            return None
        if param == "50/60 km":
            return 60
        ...
        if (
            param
            == "100 km (Bez problemowa możliwość zmiany miejsca zamieszkania z pomocą klubu)"
            or param == "100km, możliwość przeprowadzki"
        ):
            return 100
        if param == "do 30km":
            return 30
        ...
        if (
            param == "Zbąszyńska 1"
            or param == "Andersa 178"
            or param == "Kornela Makuszyńskiego 21"
            or param == "Chorzowska  11"
            or param == "Mickiewicza 70"
            or param == "Ul.plac 1-go Maja 3/1"
            or param == "11-Go Listopada 2 /28"
            or param == "Plac Grunwaldzki"
            or param == "Bohaterów Modlina 22/15"
            or param == "Szaflika 10"
        ):
            return None
        if (
            param == "Bez różnicy wszędzie dojadę "
            or param == "nieokreślone"
            or param == "Nie ma różnicy"
            or param == "jestem otwarty na propozycje"
            or param == "odległość nie ma dla mnie znaczenia"
            or param == "bez znaczenia"
            or param == "w razie potrzeby moge zmienci miejsce zamieszkania"
            or param == "Bez ograniczeń"
            or param == "bez różnicy"
            or param == "Jestem w stanie zmienić miejsce zamieszkania"
            or param == "600 (możliwa przeprowadzka)"
        ):
            return 500
        if (
            param == "Koszalińska 64E/5"
            or param == "Turkusowa 26"
            or param == "Aleksandry Śląskiej"
            or param == "W zależności od klubu"
            or param == "Słopnice 1050"
            or param == "Kamienna 5/1"
            or param == "Nie jestem w stanie określić"
            or param == "Mickiewicza 95/6"
            or param == "Brzozowa 1"
        ):
            return None
        ...
        if (
            param == "100km"
            or param == "100 km"
            or param == "100 /możliwość przeprowadzki"
        ):
            return 100
        if param == "130km":
            return 130
        ...
        if (
            param
            == "70-100km, w zależności od oferty jestem w stanie rozważyć dalsze wyjazdy lub przeprowadzkę"
        ):
            return 100
        if param == "100-150km":
            return 150
        if (
            ...
            or param == "Wszędzie"
            or param == "obojętnie"
            or param == "Odległość nieokreślona "
            or param == "bez znaczenia"
            or param == "nie ma znaczenia"
            or param == "dowolna odległość km"
        ):
            return 500
        if param == "Internat?":
            return None
        ...
        if param == "5km":
            return 5
        if (
            (param.startswith("50 ") and param.endswith("ie"))
            or param == "50 km"
            or param == "50km"
        ):  # == '50 bądź mieszkać w bursie' or param  =='50 bądź mieszkać w bursie':
            return 50
    ...
    def handle(self, *args, **options):
        ...
        with open(options["path"], newline="") as csvfile:
            ...
            for i, row in enumerate(reader):
                ...
                motivation = ""
                if (
                    motivation1 is not None
                    or motivation2 is not None
                    or motivation3 is not None
                    or motivation_other is not None
                ):
                    if about is None:
                        about = ""
                    motivation = "\n\nMotywacja:\n"
                ...
                profile.practice_distance = self.practice_distance_map(
                    practice_distance
                )
                ...
                if (
                    ...
                    facebook_url = (
                        "https://m.facebook.com/profile.php?id=100015687040622"
                    )
                ...
                profile.team_club_league_voivodeship_ver = (
                    team_club_league_voivodeship_ver
                )
                profile.save()
