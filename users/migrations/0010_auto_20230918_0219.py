...
def create_userpreferences(apps, user_id: int) -> UserPreferences:
    """Create UserPreferences for given user"""
    ...
    for profile_model in PROFILE_MODELS_WITH_COUNTRY:
        for profile in profile_model.objects.all():
            ...
            try:
                ...
                user_prefs = create_userpreferences(apps, profile.user.id)
