...
class UserAdminPanel(UserAdmin):
    ...
    list_display = ('username', 'first_name', 'last_name', 'state', 'is_active', 'last_login', 'date_joined', 'get_profile', 'get_profile_permalink', linkify('profile'), 'get_profile_percentage', 'declared_role')
