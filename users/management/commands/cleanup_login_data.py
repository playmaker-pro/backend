...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Starting cleanup of login data older than {days_to_keep} days..."))
        ...
        try:
            ...
            if success:
                self.stdout.write(self.style.SUCCESS("Successfully cleaned up old login data."))
            else:
                self.stdout.write(self.style.ERROR("Cleanup failed. Check logs for details."))
